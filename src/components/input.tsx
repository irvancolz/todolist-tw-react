...
type InputProps = { withIcon?: boolean } & ComponentProps<"input">;
...
export function Input({
  ...
  return (
    <div className="border border-main-purple outline outline-offset-1 outline-transparent outline-2 has-[:focus]:outline-focus-purple dark:border-main-light dark:has-[:focus]:outline-main-light flex gap-4 text-sm flex-grow  rounded-[5px] py-3 px-4">
      <input
        className="h-full flex-grow outline-none bg-transparent border-none  dark:text-main-light"
        type="text"
      ...
      {withIcon && (
        <svg
          ...
          viewBox="0 0 21 22"
          fill="none"
          className="text-main-purple dark:text-main-light"
